...
require 'src/states/entity/bluesnail/BlueSnailChasingState'
require 'src/states/entity/bluesnail/BlueSnailIdleState'
require 'src/states/entity/bluesnail/BlueSnailMovingState'
require 'src/states/entity/bluesnail/BlueSnailParalysedState'
require 'src/states/entity/bluesnail/BlueSnailMovingShellState'
...
gTextures = {
    ...
    ['creatures2'] = love.graphics.newImage('graphics/creatures.png'),
    ['keys'] = love.graphics.newImage('graphics/keys_and_locks.png'),
    ['flag'] = love.graphics.newImage('graphics/flags.png'),
    ['star'] = love.graphics.newImage('graphics/hearts.png'),
...
gFrames = {
    ...
    ['creatures2'] = GenerateQuads(gTextures['creatures'], 16, 16),
    ['keys'] = GenerateQuads(gTextures['keys'], 16, 16),
    ['flag'] = GenerateQuads(gTextures['flag'], 16, 16),
    ['star'] = GenerateQuads(gTextures['star'], 16, 16),
